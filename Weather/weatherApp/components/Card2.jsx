...
const Card2 = () => {
    ...
    return (
        ...
        <div className=" overflow-hidden bg-gradient-to-r from-[#372F69] via-[#3E2E73] to-[#2F2C58] backdrop-blur-md w-[390px] h-[744px] rounded-[35px] flex-col flex justify-start shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
